<template>
  ...
  >
    <KPageContainer>
      ...
      <div class="collection-channel-browser">
        <p>Channel browser goes here</p>
      </div>
    </KPageContainer>
  </CoreBase>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      ...mapState('collectionContent', ['collectionEditorData', 'channel', 'topic']),
      channelId() {
